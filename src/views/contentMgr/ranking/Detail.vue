    ...
    >
      <div class="detail-dialog-wrap">
        ...
        />           
          ...
          <el-form-item label="将" prop="id">
        <el-input
          v-model="useData.nickname"
          name="title"
          tabindex="1"
          style="width:57%;"
          auto-complete="off"
        />           
                   ...
                   <el-form-item label="替换为" prop="id">
        <el-input
          v-model="useData.nicknamenew"
          name="title"
          tabindex="1"
          style="width:57%;"
          auto-complete="off"
        ...
        <el-button type="primary" style="width:10%;margin-left:50%;margin-top:20px;" size="small" @click="handleAddMember()">确认</el-button>
...
<script>
import { update_by_nickname,get_upload_token,update_banner} from '@/api/contentMgr'
...
export default {
  ...
  methods: {
    ...
    {
      let from =  this.useData.nickname;
      let to =  this.useData.nicknamenew;
      let date =  this.useData.date;

      let data = ({ from:from,to: to, date: date});
       console.log(data)
      let ret = update_by_nickname(data);
