      ...
      <div class="detail-dialog-wrap">
        <vue-scroll>
          <el-form
            ...
            label-width="140px"
          >
            <el-form-item label="商户名称" prop="id">
        <el-input
          v-model="useData.barName"
          name="barName"
          tabindex="1"
          style="width:50%;"
          auto-complete="off"
        />           
            ...
            <el-form-item label="商户logo" prop="reportUserId">
...
　　　　　　　<el-button
            ...
            >
              ...
              <img :src="useData.logo" v-else alt />
        ...
        <el-input
          ...
          auto-complete="off"
        />                     </el-form-item>
            <el-form-item label="商户坐标" prop="accuseId">
        X：<el-input
          v-model="useData.lng"
          name="lng"
          tabindex="1"
        ...
        />                 
                      ...
                      <el-form-item label="城市" prop="id">
        <el-input
          v-model="useData.city"
          name="city"
          tabindex="1"
          style="width:50%;"
          auto-complete="off"
        />           
            ...
            <el-form-item label="范围半径" prop="accuseType">
        <el-input
          v-model="useData.range"
          name="range"
          tabindex="1"
          style="width:50%;"
          auto-complete="off"
        />                 米    </el-form-item>
            <el-form-item label="商户电话" prop="accuseName">
        <el-input
          v-model="useData.tel"
          name="tel"
          tabindex="1"
      ...
      >
        ...
        <el-button type="primary" style="width:10%;margin-left:50%;margin-top:20px;" v-if="this.useData.barId"  size="small" @click="handleAddMember()">更新</el-button>
...
export default {
  ...
  methods: {
    ...
    {
      let barName =  this.useData.barName;
            let address =  this.useData.address;
      let lat =  this.useData.lat;
      let lng =  this.useData.lng;
      let range =  this.useData.range;
      let tel =  this.useData.tel;
      let status = 0;
      status = this.chartRadio === '启用' ? 1: 0;
      let logo  = this.tempImg;
      let city = this.useData.city;
      if(this.useData.barId)
      {
        if(this.tempImg)
        {
          this.useData.logo = this.tempImg;
        }
         let data = ({ barName: barName, address: address, lat: lat, lng: lng, range: range, tel: tel,city:city, status: status, logo: this.useData.logo,barId:this.useData.barId});
       console.log(data)
      update_bar(data);
      ...
      {
      let data = ({ barName: barName, address: address, lat: lat, lng: lng, range: range, tel: tel, status: status, logo: logo,city:city});
      console.log(data)
      add_bar(data);
