    ...
    async handleAddMember()
    {
      ...
      if(this.useData.id)
      {
        if(this.tempImg)
        {
         ...
         let data = ({ title: title, city:city,content: content, userId: userId, startTime: startTime, endTime: endTime, lat: lat, lng: lng, address: address,status:status,pics:this.useData.pics,id:this.useData.id});
       console.log(data)
      ...
      {
         let data = ({ title: title, city:city,content: content, userId: userId, startTime: startTime, endTime: endTime, lat: lat, lng: lng, address: address,status:status,pics:pics});
      console.log(data)
